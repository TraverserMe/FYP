...
export default function ItemCard({ item, index }) {
  return (
    <>
    <div key={index} className="max-w-md mx-5 my-2 bg-white rounded-xl shadow-md overflow-hidden lg:max-w-8xl">
          ...
          <div className="lg:flex lg:w-full w-75 ">
              <div className="lg:shrink-0">
                  <Image
                    ...
                    height={100}
                    priority={true}
                    className="h-40 w-auto object-cover mx-auto lg:h-full lg:w-full"
                  />
