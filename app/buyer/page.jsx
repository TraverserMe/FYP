...
import chectMetav2 from "../components/chectMetav2";
...
export default function BuyerDashboard() {
    ...
    return (
        <>
            {!isConnected && <h1 className='text-xl'>Welcome, connect Metamask to buy or or sell item (Dashboard too)</h1>}
            {isConnected && 
            <>
                {items && !loading ? 
                    <div className='container mx-auto w-100 text-center'>
                        <h2 className='text-xl'>Buyer History</h2>
